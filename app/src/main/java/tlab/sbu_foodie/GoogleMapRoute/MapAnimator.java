...
/**
 * Route displaying animator
 * Created by amal.chandran on 22/12/16.
 * This code was copied from amal.chandran, https://github.com/amalChandran/trail-android
 */
...
public class MapAnimator {
    ...
    static final int BLUE = Color.parseColor("#46A4FF");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> diningRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().add(diningRoute.get(0)).color(BLUE).width(7);
        backgroundPolyline = googleMap.addPolyline(optionsBackground);

        optionsForeground = new PolylineOptions().add(diningRoute.get(0)).color(Color.BLACK).width(7);
        foregroundPolyline = googleMap.addPolyline(optionsForeground);

        final ValueAnimator percentageCompletion = ValueAnimator.ofInt(0, 100);
        percentageCompletion.setDuration(1500);
        ...
        percentageCompletion.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                foregroundPolyline.setColor(BLUE);
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), BLUE, Color.BLACK);
        ...
        ObjectAnimator foregroundRouteAnimator = ObjectAnimator.ofObject(this, "routeIncreaseForward", new RouteEvaluator(), diningRoute.toArray());
